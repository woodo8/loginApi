...
export declare class DocumentProducer {
     ...
     * @hidden
     */
    constructor(clientContext: ClientContext, collectionLink: string, query: SqlQuerySpec, targetPartitionKeyRange: PartitionKeyRange, options: FeedOptions, correlatedActivityId: string);
    /**
     ...
     */
    bufferMore(diagnosticNode: DiagnosticNodeInternal): Promise<Response<any>>;
    /**
